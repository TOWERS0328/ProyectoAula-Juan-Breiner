...
import service.residue.util.validations.ValidationExistResidueByCode;

public class AdministradorRecycling extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public AdministradorRecycling() {
    ...
    private void initComponents() {
        ...
        txtObjectU.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtObjectUKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtObjectUKeyTyped(evt);
            }
        });
                    ...
                    .addGroup(pnUpdateLayout.createSequentialGroup()
                        .addGroup(pnUpdateLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(pnUpdateLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtObjectU))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnUpdateLayout.createSequentialGroup()
                                .addComponent(jLabel23, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(CodeCurrent, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnInterUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInterUpdateActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Correctly modified residue");
            residueController.showResidueController(tbUpdate);
    ...
    private void btnKeepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeepActionPerformed
        ...
        ValidationExistResidueByCode validator = new ValidationExistResidueByCode();

        if (validator.exist(code)) {
            JOptionPane.showMessageDialog(null, "The waste code is already registered.");
        ...
        if (points <= 0) {
            ...
            JOptionPane.showMessageDialog(null, "Waste created successfully");
            limpiar();
            }
        } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "The points field must contain a valid integer.");
    ...
    private void txtObjectUKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtObjectUKeyTyped
        char c = evt.getKeyChar();
        if (!Character.isLetter(c) && !Character.isWhitespace(c) && !Character.isISOControl(c)) {
            evt.consume();
        }
    }//GEN-LAST:event_txtObjectUKeyTyped

    private void txtObjectUKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtObjectUKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            txtPointsU.requestFocus();
        }
    }//GEN-LAST:event_txtObjectUKeyPressed

    private void txtPointsUKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPointsUKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            TxtTypeU.requestFocus();
        }
    }//GEN-LAST:event_txtPointsUKeyPressed

    private void TxtTypeUKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtTypeUKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            btnInterUpdate.requestFocus();
        }
    }//GEN-LAST:event_TxtTypeUKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradorRecycling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministradorRecycling().setVisible(true);
            }
        });
    }
